...
def generar_invitados():
    candidad=int(input("Cantidad de invitados a Registrar:\n"))
    lista_invitados=[]
    for i in range(candidad):
        lista_invitados.append(str(input("Nombre del invitado:\n")))
...
if __name__ == '__main__':
    ...
    print("La lista ordenada:", lista_invidatos_ordenada)
    print("terminamos")
