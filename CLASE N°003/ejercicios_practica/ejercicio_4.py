...
if texto_1 > texto_2:
    print('Texto {} es mayor que Texto {}'.format(texto_1, texto_2))
elif texto_1 == texto_2:
    print('Texto {} es igual a Texto {}'.format(texto_1, texto_2))
else:
    print('Texto {} es mayor que Texto {}'.format(texto_2, texto_1))
