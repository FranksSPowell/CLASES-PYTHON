...
print("La suma de {} y {} es {}".format(numero_1,numero_2,operacion1))
# Resta
operacion2=numero_1-numero_2
print("La resta de {} y {} es {}".format(numero_1,numero_2,operacion2))
# División
operacion3=numero_1/numero_2
print("La División de {} y {} es {}".format(numero_1,numero_2,operacion3))
# Multiplicación
operacion4=numero_1*numero_2
print("La Multiplicación de {} y {} es {}".format(numero_1,numero_2,operacion4))
