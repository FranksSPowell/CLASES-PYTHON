...
NombreCompleto=str(input("su nombre completo: "))

print("Su nombre en minuscula {}".format(str.lower(NombreCompleto)))
print("Su nombre en MAYUSCULA {}".format(str.upper(NombreCompleto)))
print("Su nombre en Capitalizado {}".format(str.capitalize(NombreCompleto)))