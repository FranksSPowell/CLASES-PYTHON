...
Nombre_Padre1=str(input("Nombre completo de su Padre 1(nombre apellido) "))
Nombre_Padre2=str(input("Nombre completo de su Padre 2(nombre apellido) "))
Nombre_Usuario=str(input("Nombre del Hijo/a "))

NombrePadre1, ApellidoPadre1=Nombre_Padre1.split(" ")
NombrePadre2, ApellidoPadre2=Nombre_Padre2.split(" ")

print("El nombre del Hijo/a es {} {} {}".format(Nombre_Usuario, ApellidoPadre1, ApellidoPadre2))
